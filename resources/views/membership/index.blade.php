        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
            <div>
                <h5 class="fw-bold py-3 mb-0">
                    <span class="text-muted fw-light">Home /</span> Membership
                </h5>
                <p class="text-muted mb-0">Kelola transaksi dan paket membership member gym.</p>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('products.index') }}" class="btn btn-outline-primary">
                    <i class="bx bx-package me-1"></i> Kelola Paket Layanan
                </a>
        ...
        <div class="card">
            ...
            <div class="card-header border-bottom py-3">
                <form action="{{ route('memberships.index') }}" method="GET" class="row g-2 align-items-center">
                    ...
                    <div class="col-md-4 col-6 d-flex gap-2 justify-content-md-end">
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse ($memberships as $membership)
                            <tr>
                                ...
                                <td>
                                    <span class="fw-semibold text-success">{{ $membership->formatted_price }}</span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="d-flex flex-column align-items-center justify-content-center w-100 py-3">
                                        ...
                                        <span class="text-muted">Klik tombol "Tambah Membership" untuk mendaftarkan transaksi pertama.</span>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
