        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="bx bx-id-card me-1 text-primary"></i> Tambah Transaksi Membership
                </h5>
            ...
            <form action="{{ route('memberships.store') }}" method="POST" id="formTambahMembership">
                ...
                <div class="modal-body">
                    ...
                    <!-- Periode: Tanggal Mulai & Berakhir -->
                    <div class="row">
                        ...
                        <!-- Tanggal Berakhir (Otomatis / Dihitung Sistem) -->
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text text-muted small">
                                Dihitung otomatis oleh sistem dari durasi paket.
                            </div>
                            @if (old('_modal') === 'create_membership')
                                @error('end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="1000" min="0"
                                ...
                                value="{{ old('_modal') === 'create_membership' ? old('price') : '' }}" required />
                        </div>
                        @if (old('_modal') === 'create_membership')
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
