                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="search" name="search" class="form-control"
                                placeholder="Ketik nama, email, kode, atau no. HP..." value="{{ request('search') }}" />
                        </div>
                    </div>
                                ...
                                <td class="text-center">
                                    <div class="d-inline-flex gap-1">
                                        ...
                                        <button type="button" class="btn btn-sm btn-icon btn-outline-warning"
                                            title="Edit Member" data-bs-toggle="modal"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (modalDetail) {
                modalDetail.addEventListener('show.bs.modal', function(event) {
                    ...
                    if (statusEl) {
                        statusEl.textContent = status === 'Active' ? 'Aktif' : (status === 'Inactive' ? 'Tidak Aktif' : status);
                        statusEl.className = 'badge ' + (status === 'Active' ? 'bg-label-success' : 'bg-label-danger');
                    }
                ...
                switchEl.addEventListener('change', function() {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            if (tr) {
                                const detailBtn = tr.querySelector('[data-bs-target="#modalDetailMember"]');
                                if (detailBtn) detailBtn.setAttribute('data-status', data.status);

                                const editBtn = tr.querySelector('[data-bs-target="#modalEditMember"]');
