        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    ...
                    <p class="mb-0"><span id="detailKodeMember" class="badge bg-label-secondary font-monospace"></span></p>
                </div>
                    ...
                    <table class="table table-borderless mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>: <span class="badge bg-label-primary">Member</span></td>
                            </tr>
                            <tr>
                                <th class="ps-0">
                            ...
                            <tr>
                                <th class="ps-0">
                                    <i class="bx bx-calendar me-1 text-primary"></i> Terdaftar pada
                                </th>
