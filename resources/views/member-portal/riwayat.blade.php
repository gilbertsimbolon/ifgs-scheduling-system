...
@section('content')
    ...
    <!-- Nav Pills / Tabs: Presensi Gym & Riwayat Jadwal -->
    <ul class="nav nav-pills nav-fill mb-3 bg-white p-1 rounded-3 border shadow-sm" id="riwayatTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active py-2 fw-semibold rounded-2" id="presensi-tab" data-bs-toggle="pill" data-bs-target="#presensi-pane" type="button" role="tab" aria-controls="presensi-pane" aria-selected="true" style="font-size: 0.8rem;">
                <i class="bx bx-check-circle me-1"></i> Kehadiran Gym
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link py-2 fw-semibold rounded-2" id="jadwal-tab" data-bs-toggle="pill" data-bs-target="#jadwal-pane" type="button" role="tab" aria-controls="jadwal-pane" aria-selected="false" style="font-size: 0.8rem;">
    ...
    <div class="tab-content" id="riwayatTabContent">
        <!-- 1. Tab Kehadiran / Absensi -->
        <div class="tab-pane fade show active" id="presensi-pane" role="tabpanel" aria-labelledby="presensi-tab" tabindex="0">
